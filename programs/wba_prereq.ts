...
//Since instructions, metadate and address are not optional we populated our IDL object with examples
//This create the IDL object for the WBA prerequisite data structure
export const IDL: WbaPrereq = { 
    ...
    metadata: { 
        name: "wba_prereq",
        version: "0.1.0",
        description: "WBA Prerequisite Program Description",
        spec: "0.1.0" 
     },
